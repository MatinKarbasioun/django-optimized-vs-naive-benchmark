...
def test_pagination_is_working(async_client, specific_users):
...
def test_customers_filters(async_client, specific_users, filter_param, filter_value, expected_count):
...
def test_relationships_filters(async_client, specific_users, filter_param, filter_value, expected_count):
    url = f"{reverse(VIEW_NAME)}?{filter_param}={filter_value}"
    response = async_client.get(url)
...
def test_address_filters(async_client, specific_users, filter_param, filter_value, expected_count):
    url = f"{reverse(VIEW_NAME)}?{filter_param}={filter_value}"
    response = async_client.get(url)
...
def test_search_filter(async_client, specific_users, search_term, expected_count):
...
def test_combined_filters(async_client, specific_users):
...
def test_sorting(async_client, specific_users, country, sort_by, ordering, expected_first_name):
