...
def specific_users(django_db_setup, django_db_blocker):
    ...
    with django_db_blocker.unblock():
        ...
        # User 3
        user3 = AppUserModel.objects.acreate(
